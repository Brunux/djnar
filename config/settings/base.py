...
)  # (djinar/config/settings/base.py - 3 = djinar/)
APPS_DIR = BASE_DIR.path("djinar")
...
MIGRATION_MODULES = {
    "sites": "djinar.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "djinar.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("Bruno Granados", "me@brunux.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "djinar.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "djinar.users.adapters.SocialAccountAdapter"
)
